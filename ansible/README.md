# **Настройка кластера для поддержки функции Routing Behind Mobile Station (MS) vUGW9811/UGW9811/GGSN9811 компании Huawei**
...
Логика работы позволяет добавлять маршрут как по номеру абонента так и по его IP адресу. Для добавления маршрута первоначально должен быть создан APN и добавлен в него номер либо IP адрес абонента. Возможно добавление обоих параметров, но при работе приоритетными будут маршруты прописанные по IP адресу.
